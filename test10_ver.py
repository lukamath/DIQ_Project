...
raw_file_path= "D:/Politecnico/LM/Data and Information Quality/Project/raw_movies10.csv"
input_file_path = "D:/Politecnico/LM/Data and Information Quality/Project/cleaned_movies10.csv"
output_file_path= "D:/Politecnico/LM/Data and Information Quality/Project/cleaned_movies10_ver.csv"
valid_file_path = "D:/Politecnico/LM/Data and Information Quality/Project/valid_rows10.csv"
invalid_file_path = "D:/Politecnico/LM/Data and Information Quality/Project/invalid_rows10.csv" 

with open(raw_url, 'r', encoding='utf-8') as rawfile, open(output_file_path, 'w', encoding='utf-8') as outfile:
    for line in rawfile:
